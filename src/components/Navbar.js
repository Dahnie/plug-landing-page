...
const Navbar = () => {
    return (
        <nav className="navbar flex items-center md:justify-between py-3 font-body text-primary bg-white sticky top-0 z-30 w-full">
            <div className="left logo inline px-6 md:px-16 ">
                <img width="60" height="60" src={logo} alt="logo" />
            </div>
            <div className="middle lg:inline hidden">
            ...
            <div className="right md:inline hidden pr-24 font-semibolder">
